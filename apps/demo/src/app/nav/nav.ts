        ...
        <div class="nav__actions">
          ...
          >
            <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor">
              ...
              <path d="M12 2C6.477 2 2 6.477 2 12c0 2.159.685 4.158 1.854 5.8L2.5 21.5l3.826-1.312A9.954 9.954 0 0012 22c5.523 0 10-4.477 10-10S17.523 2 12 2zm0 18c-1.782 0-3.435-.468-4.869-1.284l-.349-.2-.228.078-2.259.775.789-2.203.084-.236-.217-.358A7.954 7.954 0 014 12c0-4.411 3.589-8 8-8s8 3.589 8 8-3.589 8-8 8z"/>
            </svg>
          </a>
