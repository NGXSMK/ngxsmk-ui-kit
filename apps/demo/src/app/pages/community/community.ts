...
@Component({
  ...
  template: `
    ...
    <div class="ngxsmk-page">
      <header class="ngxsmk-page__header">
        ...
        <ngxsmk-text variant="body" class="ngxsmk-page__sub">Join our growing community, ask questions, propose features, and share what you've built.</ngxsmk-text>
      </header>
      ...
      <div class="ngxsmk-community-grid">
        <ngxsmk-card class="ngxsmk-community-card">
          ...
          <div ngxsmkCardContent>
            <ngxsmk-text variant="body" class="ngxsmk-community-desc">Ask questions, share suggestions, and get feedback from developers and contributors on our discussions forum.</ngxsmk-text>
  ...
  styles: `
    ...
    .ngxsmk-community-grid { display: grid; grid-template-columns: repeat(auto-fill,minmax(min(22rem,100%),1fr)); gap: var(--ngxsmk-space-6,1.5rem); }
    .ngxsmk-community-card { display: flex; flex-direction: column; height: 100%; }
    .ngxsmk-community-desc { color: var(--ngxsmk-color-on-surface-variant,#71717a); font-size: 0.875rem; line-height: 1.6; margin: 0 0 var(--ngxsmk-space-4,1rem); }
  `,
})
