...
The component library of the [NGXSMK UI kit](https://github.com/NGXSMK/ngxsmk-ui-kit): 170+ standalone, `OnPush`, signals-based components — forms, navigation, data display, overlays, AI/chat, charts, and enterprise widgets. Also exposes animation helpers (`@ngxsmk/core/animation`) and an SEO service (`@ngxsmk/core/seo`).
...
See the [demo app](https://github.com/NGXSMK/ngxsmk-ui-kit/tree/main/apps/demo) for live examples of every component.
