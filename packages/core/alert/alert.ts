...
@Component({
  ...
  styles: `
    ...
    .ngxsmk-alert__icon { flex-shrink: 0; margin-top: 0.125rem; }

    .ngxsmk-alert__body { flex: 1; min-width: 0; }
    ...
    .ngxsmk-alert__content { margin: 0; }
    ...
    .ngxsmk-alert__close:hover { opacity: 1; }
