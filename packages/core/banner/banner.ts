...
@Component({
  ...
  styles: `
    ...
    .ngxsmk-banner__icon { flex-shrink: 0; }

    .ngxsmk-banner__body { flex: 1; min-width: 0; }

    .ngxsmk-banner__content { margin: 0; }
    ...
    .ngxsmk-banner__close:hover { opacity: 1; }
