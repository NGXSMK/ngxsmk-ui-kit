...
@Component({
  ...
  styles: `
    ...
    :host([data-level='h1']) {
      ...
      line-height: var(--ngxsmk-text-display-md-line);
    }
    :host([data-level='h2']) {
    ...
    :host([data-level='h3']) {
      ...
      line-height: var(--ngxsmk-text-headline-md-line);
    }
    :host([data-level='h4']) {
    ...
    :host([data-level='h6']) {
      ...
      line-height: var(--ngxsmk-text-title-md-line);
    }

    :host([data-weight='light']) {
      font-weight: 300;
    }
