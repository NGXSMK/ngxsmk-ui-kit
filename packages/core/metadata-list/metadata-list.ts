...
@Component({
  ...
  styles: `
    ...
    .ngxsmk-metadata-list__dl {
      display: grid;
      grid-template-columns: auto 1fr;
      gap: var(--ngxsmk-space-2) var(--ngxsmk-space-4);
      margin: 0;
    }
    ::ng-deep .ngxsmk-metadata-list-item {
      display: contents;
    }
    ::ng-deep .ngxsmk-metadata-list-item dt {
      color: var(--ngxsmk-color-on-surface-variant);
      font-size: var(--ngxsmk-text-body-sm-size);
      white-space: nowrap;
    }
    ::ng-deep .ngxsmk-metadata-list-item dd {
      margin: 0;
