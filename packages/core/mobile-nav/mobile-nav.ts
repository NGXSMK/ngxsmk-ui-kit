...
@Component({
  ...
  template: `
    @if (open()) {
      ...
      <div
        class="ngxsmk-mobile-nav__panel"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div class="ngxsmk-mobile-nav__header">
          ...
          <button
            type="button"
            class="ngxsmk-mobile-nav__close"
            (click)="close()"
  ...
  styles: `
    ...
    .ngxsmk-mobile-nav__close:hover {
...
@Component({
  ...
  template: `
    <button
      type="button"
      class="ngxsmk-mobile-nav-toggle__btn"
      (click)="toggled.emit()"
  ...
  styles: `
    ...
    .ngxsmk-mobile-nav-toggle__btn:hover {
      background: var(--ngxsmk-color-surface-hover);
    }
  `,
  changeDetection: ChangeDetectionStrategy.OnPush,
