...
@Component({
  ...
  template: `
    <button
      type="button"
      class="ngxsmk-nav-heading-menu__trigger"
      (click)="open.set(!open())"
  ...
  styles: `
    ...
    .ngxsmk-nav-heading-menu__trigger {
      display: flex;
      align-items: center;
    ...
    .ngxsmk-nav-heading-menu__trigger svg {
      transition: transform var(--ngxsmk-duration-fast) var(--ngxsmk-ease-out);
    }
    .ngxsmk-nav-heading-menu__trigger svg.rotated {
      transform: rotate(180deg);
    }
    .ngxsmk-nav-heading-menu__items {
      display: flex;
      flex-direction: column;
      gap: var(--ngxsmk-space-1);
      padding: var(--ngxsmk-space-1) 0 var(--ngxsmk-space-1) var(--ngxsmk-space-4);
    }
  `,
