...
@Component({
  ...
  styles: `
    :host {
      display: block;
      background: var(--ngxsmk-terminal-bg, var(--ngxsmk-color-neutral-950));
      color: var(--ngxsmk-terminal-fg, var(--ngxsmk-color-neutral-300));
