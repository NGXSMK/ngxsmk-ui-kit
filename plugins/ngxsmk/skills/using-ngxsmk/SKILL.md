...
Install via the NGXSMK Claude Code plugin
(`/plugin marketplace add NGXSMK/ngxsmk-ui-kit`, then `/plugin install ngxsmk@ngxsmk`),
or copy this skill folder into any consumer project's `.claude/skills/`.
