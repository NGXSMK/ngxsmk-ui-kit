...
- compare-image: Typography values should use var(--ngxsmk-text-_) / var(--ngxsmk-font-_)
- notification-center: Typography values should use var(--ngxsmk-text-_) / var(--ngxsmk-font-_)
- tour: Typography values should use var(--ngxsmk-text-_) / var(--ngxsmk-font-_)
